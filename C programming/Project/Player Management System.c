...
void main()
{
	...
	do{
		...
		printf("3. Add players\n");
		printf("4. Search players\n");
		printf("5. Remove players\n");
		printf("6. Update players\n");
...
void searchby_name(p *arr,int size)
{
	...
	if(flag==1)
	{
		...
		printf("\nMatches played by player : %d",arr[index].matches);
	}
	else
	printf("\nplayer not found\n");
...
void add_player(p *arr,int *size)
{
    	...
    	printf("player added sucessfully\n");
...
void store(p *arr,int size)
{
	for(int i=0;i<size;i++)
	{
		printf("\nEnter jerseynumber of player %d: \n",i+1);
    	scanf("%d",&arr[i].jerseynumber);
    	getchar();
    	...
    	printf("Enter runs of player %d : \n",i+1);
  		...
  		printf("Enter wickets of player %d : \n",i+1);
    	scanf("%d",&arr[i].wickets);
    	
    	printf("Enter matches played by player %d : \n",i+1);
    	scanf("%d",&arr[i].matches);	
	}
